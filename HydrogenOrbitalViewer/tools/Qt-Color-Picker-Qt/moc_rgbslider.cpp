...
QT_MOC_LITERAL(1, 10, 10), // "redChanged"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 12), // "greenChanged"
QT_MOC_LITERAL(4, 35, 11) // "blueChanged"

    },
    "RGBSlider\0redChanged\0\0greenChanged\0"
    "blueChanged"
};
...
void RGBSlider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->redChanged((*reinterpret_cast< QColor(*)>(_a[1]))); break;
        case 1: _t->greenChanged((*reinterpret_cast< QColor(*)>(_a[1]))); break;
        case 2: _t->blueChanged((*reinterpret_cast< QColor(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (RGBSlider::*)(QColor );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RGBSlider::redChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (RGBSlider::*)(QColor );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RGBSlider::greenChanged)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (RGBSlider::*)(QColor );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RGBSlider::blueChanged)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void RGBSlider::redChanged(QColor _t1)
{
...
// SIGNAL 1
void RGBSlider::greenChanged(QColor _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void RGBSlider::blueChanged(QColor _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
