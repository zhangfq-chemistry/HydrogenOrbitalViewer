...
QT_MOC_LITERAL(5, 48, 11), // "ctrlPressed"
QT_MOC_LITERAL(6, 60, 12) // "ctrlReleased"

    },
    "ColorSlider\0middlePressedSignal\0\0"
    "QMouseEvent*\0e\0ctrlPressed\0ctrlReleased"
};
...
void ColorSlider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ColorSlider *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->middlePressedSignal((*reinterpret_cast< QMouseEvent*(*)>(_a[1]))); break;
        case 1: _t->ctrlPressed(); break;
        case 2: _t->ctrlReleased(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ColorSlider::*)(QMouseEvent * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ColorSlider::middlePressedSignal)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ColorSlider::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_ColorSlider.data,
    qt_meta_data_ColorSlider,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void ColorSlider::middlePressedSignal(QMouseEvent * _t1)
{
