...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Services_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Services_t qt_meta_stringdata_Services = {
    {
QT_MOC_LITERAL(0, 0, 8) // "Services"
...
QT_INIT_METAOBJECT const QMetaObject Services::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_Services.data,
    qt_meta_data_Services,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Services::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Services.stringdata0))
