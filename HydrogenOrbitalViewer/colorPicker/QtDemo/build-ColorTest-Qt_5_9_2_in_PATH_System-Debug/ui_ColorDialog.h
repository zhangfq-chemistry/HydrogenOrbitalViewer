...
"}"));
        ...
        topWgt = new QWidget(ColorDialog);
        topWgt->setObjectName(QStringLiteral("topWgt"));
        topWgt->setMinimumSize(QSize(0, 35));
        topWgt->setMaximumSize(QSize(16777215, 35));

        verticalLayout->addWidget(topWgt);
