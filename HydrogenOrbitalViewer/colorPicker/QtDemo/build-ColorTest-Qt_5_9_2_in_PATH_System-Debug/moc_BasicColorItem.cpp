...
#include "../ColorDialog/BasicColorItem.h"
...
QT_MOC_LITERAL(1, 15, 17), // "itemClickedSignal"
QT_MOC_LITERAL(2, 33, 0) // ""

    },
    "BasicColorItem\0itemClickedSignal\0"
};
...
void BasicColorItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        BasicColorItem *_t = static_cast<BasicColorItem *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->itemClickedSignal((*reinterpret_cast< const QColor(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (BasicColorItem::*_t)(const QColor & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&BasicColorItem::itemClickedSignal)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject BasicColorItem::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_BasicColorItem.data,
      qt_meta_data_BasicColorItem,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void BasicColorItem::itemClickedSignal(const QColor & _t1)
{
