...
#include "../color-picker/XColorDialog.h"
...
void XColorDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        XColorDialog *_t = static_cast<XColorDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (XColorDialog::*_t)(QColor );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&XColorDialog::colorChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (XColorDialog::*_t)(char );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&XColorDialog::checkedChanged)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (XColorDialog::*_t)(QColor );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&XColorDialog::colorSelected)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject XColorDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_XColorDialog.data,
      qt_meta_data_XColorDialog,  qt_static_metacall, nullptr, nullptr}
};
