...
#include "../color-picker/XColorSquare.h"
...
void XColorSquare::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        XColorSquare *_t = static_cast<XColorSquare *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (XColorSquare::*_t)(QColor );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&XColorSquare::colorChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (XColorSquare::*_t)(QColor );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&XColorSquare::colorSelected)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject XColorSquare::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_XColorSquare.data,
      qt_meta_data_XColorSquare,  qt_static_metacall, nullptr, nullptr}
};
