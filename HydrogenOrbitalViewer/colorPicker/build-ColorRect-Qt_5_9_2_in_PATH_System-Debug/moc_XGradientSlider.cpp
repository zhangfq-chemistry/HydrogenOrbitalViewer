...
#include "../color-picker/XGradientSlider.hpp"
...
void XGradientSlider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::RegisterPropertyMetaType) {
        ...
        XGradientSlider *_t = static_cast<XGradientSlider *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
...
const QMetaObject XGradientSlider::staticMetaObject = {
    { &QSlider::staticMetaObject, qt_meta_stringdata_XGradientSlider.data,
      qt_meta_data_XGradientSlider,  qt_static_metacall, nullptr, nullptr}
};
