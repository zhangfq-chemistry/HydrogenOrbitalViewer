...
#include "../../../Qt-Color-Widgets/include/QtColorWidgets/color_selector.hpp"
...
void color_widgets::ColorSelector::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ColorSelector::*_t)(ColorWheel::DisplayFlags );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ColorSelector::wheelFlagsChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (ColorSelector::*_t)(UpdateMode );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ColorSelector::updateModeChanged)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (ColorSelector::*_t)(Qt::WindowModality );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ColorSelector::dialogModalityChanged)) {
                *result = 2;
                return;
            }
        }
...
static const QMetaObject * const qt_meta_extradata_color_widgets__ColorSelector[] = {
        &color_widgets::ColorWheel::staticMetaObject,
    nullptr
};

const QMetaObject color_widgets::ColorSelector::staticMetaObject = {
    { &ColorPreview::staticMetaObject, qt_meta_stringdata_color_widgets__ColorSelector.data,
      qt_meta_data_color_widgets__ColorSelector,  qt_static_metacall, qt_meta_extradata_color_widgets__ColorSelector, nullptr}
};
