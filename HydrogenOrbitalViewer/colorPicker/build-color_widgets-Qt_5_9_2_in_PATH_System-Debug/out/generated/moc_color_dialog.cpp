...
QT_MOC_LITERAL(16, 199, 14), // "update_widgets"
QT_MOC_LITERAL(17, 214, 7), // "set_hsv"
QT_MOC_LITERAL(18, 222, 7), // "set_rgb"
QT_MOC_LITERAL(19, 230, 24), // "on_edit_hex_colorChanged"
QT_MOC_LITERAL(20, 255, 5), // "color"
QT_MOC_LITERAL(21, 261, 32), // "on_edit_hex_colorEditingFinished"
QT_MOC_LITERAL(22, 294, 20), // "on_buttonBox_clicked"
QT_MOC_LITERAL(23, 315, 16), // "QAbstractButton*"
QT_MOC_LITERAL(24, 332, 10), // "wheelFlags"
QT_MOC_LITERAL(25, 343, 10), // "ButtonMode"
QT_MOC_LITERAL(26, 354, 8), // "OkCancel"
QT_MOC_LITERAL(27, 363, 13), // "OkApplyCancel"
QT_MOC_LITERAL(28, 377, 5) // "Close"
    ...
    "update_widgets\0set_hsv\0set_rgb\0"
    "on_edit_hex_colorChanged\0color\0"
...
static const uint qt_meta_data_color_widgets__ColorDialog[] = {
 ...
 // enum data: key, value
      26, uint(color_widgets::ColorDialog::OkCancel),
      27, uint(color_widgets::ColorDialog::OkApplyCancel),
      28, uint(color_widgets::ColorDialog::Close),
...
void color_widgets::ColorDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 8: _t->update_widgets(); break;
        case 9: _t->set_hsv(); break;
        case 10: _t->set_rgb(); break;
        case 11: _t->on_edit_hex_colorChanged((*reinterpret_cast< const QColor(*)>(_a[1]))); break;
        case 12: _t->on_edit_hex_colorEditingFinished((*reinterpret_cast< const QColor(*)>(_a[1]))); break;
        case 13: _t->on_buttonBox_clicked((*reinterpret_cast< QAbstractButton*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (ColorDialog::*_t)(QColor );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ColorDialog::colorChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (ColorDialog::*_t)(QColor );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ColorDialog::colorSelected)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (ColorDialog::*_t)(ColorWheel::DisplayFlags );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ColorDialog::wheelFlagsChanged)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (ColorDialog::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ColorDialog::alphaEnabledChanged)) {
                *result = 3;
                return;
            }
        }
...
static const QMetaObject * const qt_meta_extradata_color_widgets__ColorDialog[] = {
        &color_widgets::ColorWheel::staticMetaObject,
    nullptr
};

const QMetaObject color_widgets::ColorDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_color_widgets__ColorDialog.data,
      qt_meta_data_color_widgets__ColorDialog,  qt_static_metacall, qt_meta_extradata_color_widgets__ColorDialog, nullptr}
};
