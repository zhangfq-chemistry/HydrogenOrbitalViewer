...
#include "../../../Qt-Color-Widgets/include/QtColorWidgets/color_line_edit.hpp"
...
void color_widgets::ColorLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ColorLineEdit *_t = static_cast<ColorLineEdit *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (ColorLineEdit::*_t)(const QColor & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ColorLineEdit::colorChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (ColorLineEdit::*_t)(const QColor & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ColorLineEdit::colorEdited)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (ColorLineEdit::*_t)(const QColor & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ColorLineEdit::colorEditingFinished)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (ColorLineEdit::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ColorLineEdit::showAlphaChanged)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (ColorLineEdit::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ColorLineEdit::previewColorChanged)) {
                *result = 4;
                return;
            }
        }
...
const QMetaObject color_widgets::ColorLineEdit::staticMetaObject = {
    { &QLineEdit::staticMetaObject, qt_meta_stringdata_color_widgets__ColorLineEdit.data,
      qt_meta_data_color_widgets__ColorLineEdit,  qt_static_metacall, nullptr, nullptr}
};
