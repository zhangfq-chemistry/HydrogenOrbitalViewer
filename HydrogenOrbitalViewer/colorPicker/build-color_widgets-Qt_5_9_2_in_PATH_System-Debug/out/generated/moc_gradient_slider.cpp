...
#include "../../../Qt-Color-Widgets/include/QtColorWidgets/gradient_slider.hpp"
...
void color_widgets::GradientSlider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        GradientSlider *_t = static_cast<GradientSlider *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (GradientSlider::*_t)(const QBrush & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GradientSlider::backgroundChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject color_widgets::GradientSlider::staticMetaObject = {
    { &QSlider::staticMetaObject, qt_meta_stringdata_color_widgets__GradientSlider.data,
      qt_meta_data_color_widgets__GradientSlider,  qt_static_metacall, nullptr, nullptr}
};
