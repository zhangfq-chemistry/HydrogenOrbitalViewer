...
#include "../../../Qt-Color-Widgets/include/QtColorWidgets/hue_slider.hpp"
...
void color_widgets::HueSlider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (HueSlider::*_t)(qreal );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&HueSlider::colorHueChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (HueSlider::*_t)(QColor );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&HueSlider::colorChanged)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (HueSlider::*_t)(qreal );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&HueSlider::colorAlphaChanged)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (HueSlider::*_t)(qreal );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&HueSlider::colorSaturationChanged)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (HueSlider::*_t)(qreal );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&HueSlider::colorValueChanged)) {
                *result = 4;
                return;
            }
        }
...
const QMetaObject color_widgets::HueSlider::staticMetaObject = {
