...
#include "../../../Qt-Color-Widgets/include/QtColorWidgets/color_list_widget.hpp"
...
void color_widgets::ColorListWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ColorListWidget *_t = static_cast<ColorListWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (ColorListWidget::*_t)(const QList<QColor> & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ColorListWidget::colorsChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (ColorListWidget::*_t)(ColorWheel::DisplayFlags );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ColorListWidget::wheelFlagsChanged)) {
                *result = 1;
                return;
            }
        }
...
static const QMetaObject * const qt_meta_extradata_color_widgets__ColorListWidget[] = {
        &color_widgets::ColorWheel::staticMetaObject,
    nullptr
};

const QMetaObject color_widgets::ColorListWidget::staticMetaObject = {
    { &AbstractWidgetList::staticMetaObject, qt_meta_stringdata_color_widgets__ColorListWidget.data,
      qt_meta_data_color_widgets__ColorListWidget,  qt_static_metacall, qt_meta_extradata_color_widgets__ColorListWidget, nullptr}
};
