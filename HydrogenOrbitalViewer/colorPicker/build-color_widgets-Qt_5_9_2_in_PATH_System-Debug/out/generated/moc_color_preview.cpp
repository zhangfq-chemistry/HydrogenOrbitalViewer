...
#include "../../../Qt-Color-Widgets/include/QtColorWidgets/color_preview.hpp"
...
void color_widgets::ColorPreview::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ColorPreview *_t = static_cast<ColorPreview *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (ColorPreview::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ColorPreview::clicked)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (ColorPreview::*_t)(QColor );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ColorPreview::colorChanged)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (ColorPreview::*_t)(QColor );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ColorPreview::comparisonColorChanged)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (ColorPreview::*_t)(DisplayMode );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ColorPreview::displayModeChanged)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (ColorPreview::*_t)(const QBrush & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ColorPreview::backgroundChanged)) {
                *result = 4;
                return;
            }
        }
...
const QMetaObject color_widgets::ColorPreview::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_color_widgets__ColorPreview.data,
      qt_meta_data_color_widgets__ColorPreview,  qt_static_metacall, nullptr, nullptr}
};
