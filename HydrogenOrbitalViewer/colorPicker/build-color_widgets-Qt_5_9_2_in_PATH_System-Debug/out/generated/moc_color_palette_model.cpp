...
#include "../../../Qt-Color-Widgets/include/QtColorWidgets/color_palette_model.hpp"
...
void color_widgets::ColorPaletteModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ColorPaletteModel *_t = static_cast<ColorPaletteModel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (ColorPaletteModel::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ColorPaletteModel::savePathChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (ColorPaletteModel::*_t)(const QStringList & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ColorPaletteModel::searchPathsChanged)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (ColorPaletteModel::*_t)(const QSize & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ColorPaletteModel::iconSizeChanged)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject color_widgets::ColorPaletteModel::staticMetaObject = {
    { &QAbstractListModel::staticMetaObject, qt_meta_stringdata_color_widgets__ColorPaletteModel.data,
      qt_meta_data_color_widgets__ColorPaletteModel,  qt_static_metacall, nullptr, nullptr}
};
